...
NTechnology = {
	...
	BASE_NEIGHBOUR_SPREAD_BONUS = 0.001, 		-- bonus for each neighbour with the tech
	NEIGHBOUR_SAME_RELIGON_GROUP_MULT = 0.001, 	-- multiplier to the above bonus if neighbour is of your religious group
	BASE_DEMESNE_SPREAD_BONUS = 0.001, 			-- bonus for each other province in demesne with the tech
	MAX_DEMESNE_BONUS = 0.001, 					-- maximum bonus from demesne
	FOCUS_BONUS = 0.001, 							-- bonus for the tech in each group set as the focus
	TRADEPOST_SPREAD_BONUS = 0.001, 			-- Spread from trade posts
	SPYACTION_SPREAD_BONUS = 0.001,				-- Spread from the target of the study technology spymaster action
	
	IDEAL_YEAR_LEVEL_0 = 700, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 9500,
	IDEAL_YEAR_AHEAD_PENALTY = -0.2,			-- UNUSED
	IDEAL_YEAR_AHEAD_PENALTY_INVEST = 50.6,		-- Percent increase in cost pre level ahead of ideal date
