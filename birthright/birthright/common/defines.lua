...
NDiplomacy = {
	...
	EXILE_IMPRISONED_INTERACTION_MONEY = 10,
	...
	PREPARE_INVASION_INTERACTION_PRESTIGE = 1500,
	...
	ASK_FOR_MONEY_INTERACTION_PIETY = 0,
	ASK_FOR_MONEY_INTERACTION_PRESTIGE = 100,
	...
	ASK_FOR_CLAIM_INTERACTION_PIETY = 0,
	...
	ASK_FOR_CRUSADE_INTERACTION_MONEY = 500,
	ASK_FOR_CRUSADE_INTERACTION_PIETY = 0,
	...
	NOMINATE_BISHOP_TO_POPE_INTERACTION_PIETY = 0,
...
NCharacter = {
	...
	MAX_CHILD_BIRTH_AGE = 2000,						-- Female menopause age.
	...
	DYNASTY_CONTROLS_HOLY_ORDER_PIETY = 0,			-- Monthly Piety from a dynasty member as head of a Holy Order (only for counts+ and if the same religion)
	...
	DYNASTY_CONTROLS_RELIGIOUS_HEAD_PIETY = 0,		-- Monthly Piety from a dynasty member as head of a religion (only for counts+ and if the same religion)
	...
	MALE_ATTRACTION_CUTOFF = 10000,					-- After this age, the sex appeal of traits no longer have any effect
	FEMALE_ATTRACTION_CUTOFF = 10000,					-- After this age, the sex appeal of traits no longer have any effect
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	MAX_REPUBLIC_COUNTIES_IN_REALM = 0.3,		-- 10% of a feudal realm is allowed to be under vassal republics (affects title grants)
	MAX_THEOCRACY_COUNTIES_IN_REALM = 0.3,		-- 10% of a feudal realm is allowed to be under vassal theocracies/bishoprics (affects title grants)
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 1520,				-- Set this to your earliest starting year
	...
	IDEAL_YEAR_LEVEL_0 = 1500, 					-- the chance to get a progress to this level will increase after this date and decrease before it
