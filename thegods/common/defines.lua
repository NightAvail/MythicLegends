...
NTechnology = {
	...
	BASE_NEIGHBOUR_SPREAD_BONUS = 0.01, 		-- bonus for each neighbour with the tech
	...
	TRADEPOST_SPREAD_BONUS = 0.01, 				-- Spread from trade posts
	SPYACTION_SPREAD_BONUS = 0.01,				-- Spread from the target of the study technology spymaster action
	
	IDEAL_YEAR_LEVEL_0 = 700, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 7500,
	IDEAL_YEAR_AHEAD_PENALTY_INVEST = 2.6,		-- Percent increase in cost pre level ahead of ideal date
